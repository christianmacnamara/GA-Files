...
puts "Welcome to the secret number game, created by #{first} #{last}"
...
puts "Hi #{name}! You have 3 guesses to guess the Secret Number between 1 and 10."
...
if guess_number == secret_number
	...
	puts "Wrong! You need to guess a lower number"
elsif guess_number < secret_number
	puts "Wrong! You need to guess a higher number"
end
...
puts "Make a second guess"

guess_number = $stdin.gets.chomp.to_i
...
puts "Make a third and final guess"

guess_number = $stdin.gets.chomp.to_i

if guess_number == secret_number
	puts "Correct!"
else puts "Wrong! You lose sucker! The secret number was #{secret_number}"
end
